...
const Cloudinary = () => {
    ...
    const cloud_name = "ddltlpsy1"                          //16.2 Pegamos el cloud_name rescatado en punto 20
...
// 24 - Le dejamos el "name" como está. ( este es el name que le pegamos despues a upload_preset en punto 16) joandr
